    ...
    <div class="w-full justify-center items-center flex px-8">
        <div class="max-w-[1384px] w-full">
            <div class="w-full flex justify-start lg:flex-col gap-4 py-8">
                <SpecTransferPart :selectedTransfer="selectedTransfer" />
                <div class="w-[322px] lg:w-full p-6 rounded-lg max-h-[600px] border-[1px] border-solid border-[#D0E1F3]">
                    ...
                    <div class="flex gap-2 mt-3 mb-6 sm:flex-col">
                        ...
                        <p class="text-[#000A15] font-medium whitespace-normal">Yerevan</p>
                    </div>
                    <div class="flex gap-2 mt-3 mb-6 sm:flex-col">
                        <p class="font-light text-[#666C73]">To: </p>
                        <p class="text-[#000A15] font-medium whitespace-normal">Gyumri</p>
                    </div>
                    <div class="flex gap-2 mt-3 mb-6 sm:flex-col">
                    ...
                    <div class="flex justify-center items-center gap-2 w-full mt-6 cursor-pointer hover:bg-[#4385CE] hover:duration-300 hover:text-[#FDFFFE] bg-primaryBlue rounded-lg px-8 py-3">
