    ...
    <div class="flex justify-evenly gap-14 h-[80px] bg-white pt-2 xl:justify-between px-8 sm:gap-2 sm:px-1 sm:justify-between">
        ...
        <div class="mt-2 w-[470px] sm:hidden md:hidden flex items-center" :class="{ 'lg:hidden md:hidden': !menu}">
            <ul class="menu flex justify-start sm:hidden items-center">
                ...
                <NuxtLink @click="closeMenu" to="/outgoings"  class="text-[16px] text-primaryGrey p-2 mr-2 cursor-pointer hover:text-primaryBlue hover:duration-300">Outgoing tours</NuxtLink>
        ...
        <div class="flex flex-row md:justify-between items-center gap-4">
            ...
            <div class="cursor-pointer ">
                ...
                <svg @click="toggleMenu" class="m-2 mt-5 ml-2 hidden sm:block md:block" :class="{ 'sm:hidden md:hidden': !menu }" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
