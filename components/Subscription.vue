<template>
    <div class="flex justify-center w-full items-center lg:max-w-[960px] lg:min-w-[250px] sm:max-w-[250px] md:max-w-[250px]">
        <div class="flex my-16 h-auto justify-center items-center max-w-[1384px] bg-[#F1F7FE] rounded-3xl xl:mx-8 lg:flex-col-reverse lg:w-[960px] sm:max-w-[280px] md:mx-2">
            <div class="max-w-[530px] min-w-[320px] mx-12 xl:mx-2 lg:max-w-[960px] lg:p-8 sm:p-2 sm:mx-0 md:mx-0">
            ...
            <div class="w-[960ox] sm:max-w-[280px]">
