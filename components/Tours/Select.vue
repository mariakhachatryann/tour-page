<template>
    <div class="flex justify-center items-center w-full mb-20">
        <div class="w-[1384px] flex justify-center p-8 rounded-3xl flex-col items-center mx-8 border-[1px] border-solid border-[#D0E1F3] bg-[#F1F7FE]">
            <div class="">
            ...
            <div class="flex w-full md:flex-wrap gap-8 my-8 sm:flex-col">
                <div class="w-2/5 sm:w-full">
                    ...
                    <!-- <input class="w-full mt-1 py-3 px-4" type="text" /> -->
                    <select name="options" class="bg-[#FFF] w-full mt-1 py-3 px-4 rounded-lg">
                        <option value="" disabled selected class="text-[#80858A] font-light">
                ...
                <div class="w-1/5 md:w-1/2">
                    ...
                    <input class="bg-[#FFF] w-full mt-1 py-3 px-4 rounded-lg" type="text" placeholder="Select type" />
                    <!-- <div>
                        <v-select :items="items" density="compact" label="Select type"></v-select>
                    </div> -->
                </div>
            </div>
            <div class="w-1/5">
            ...
            <div class="w-full mt-8">
                <button class="bg-primaryBlue rounded-lg py-3 px-8 w-full font-bold text-[#FDFFFE]">Find Results</button>
            </div>
        </div>
    </div>
</template>
